...
import '../../../public/assets/vendor/OwlCarousel2-2.3.4/dist/assets/owl.theme.default.min.css';
            ...
            <div className="col">
                ...
                <div className="row">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb m-0 mx-3">
                            <li className="breadcrumb-item"><a href="myProducts.html">Products</a></li>
                ...
                <div className="row py-2 product-detail">
                    <div className="col col-5 product-detail-img_container ">
                        ...
                        <div className="owl-carousel owl-theme product-detail-img-container_carousel">
